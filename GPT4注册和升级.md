...
- [GPT 注册和升级教程 v1.3](#gpt-注册和升级教程-v13)
  - [目录](#目录)
  - [一. 注册 GPT3.5](#一-注册-gpt35)
    ...
    - [iOS 使用 GPT 3.5](#ios-使用-gpt-35)
    - [Windows / MacOS 第三方 ChatGPT 客户端 (可选)](#windows--macos-第三方-chatgpt-客户端-可选)
  - [二. 升级 GPT4](#二-升级-gpt4)
    - [Step 1. 购买美区 Apple ID (已有可跳过)](#step-1-购买美区-apple-id-已有可跳过)
  ...
  - [六. 安卓端升级 (测试成本过高, 暂不整理)](#六-安卓端升级-测试成本过高-暂不整理)
  - [Notice](#notice)
...
- 访问 https://www.gmailbuy.com/ (该网站同时出售 Outlook 邮箱, 有意向可自行购买测试)
  - 这个网站是国内卖家进货的账号工厂之一
- 点击 "【优质】全新个人谷歌Gmail邮箱(类型2)", 支付宝支付 1.2 rmb
...
- 订阅成功后你的邮箱将收到通知, 同时网页端和客户端自动升级到 GPT4
...
- 不建议通过国内平台购买以上账号
- 不建议共享 GPT 账号, IP 频繁变动有封号风险
- 谨慎鉴别国内第三方, 不要付了 GPT4 的钱实际上使用的是 GPT3.5 的接口
